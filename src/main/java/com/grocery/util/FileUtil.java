...
/**
 * FileUtil handles file read/write operations for Product Management.
 * Data is stored in data/products.txt instead of a database.
 */
@Component
public class FileUtil {
    ...
    public boolean writeLines(String filePath, List<String> lines) {
        try {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath))) {
                writer.write("# FreshMart Products - id|name|category|price|stock|description|imageEmoji|createdAt");
                writer.newLine();
    ...
    /** Delete a line whose first field matches the id. */
    ...
    /** Replace a line whose first field matches the id. */
    ...
    /** Generate the next sequential numeric id for a file. */
